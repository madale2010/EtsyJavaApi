...
public class Transaction {
	...
	*/
	public static void findAllListingTransactions(int listingId){EtsyService.getService("/listings/"+listingId+"/transactions");}
	/**
	*Retrieves a set of Transaction objects associated to a Shop_Receipt2.
	*/
	public static void findAllShopReceipt2Transactions(int receiptId){EtsyService.getService("/receipts/"+receiptId+"/transactions");}
	/**
	*Retrieves a set of Transaction objects associated to a Shop.
	*/
	public static void findAllShopTransactions(String shopId){EtsyService.getService("/shops/"+shopId+"/transactions");}
	/**
	*Retrieves a set of Transaction objects associated to a User.
	*/
	public static void findAllUserBuyerTransactions(String userId){EtsyService.getService("/users/"+userId+"/transactions");}
}
