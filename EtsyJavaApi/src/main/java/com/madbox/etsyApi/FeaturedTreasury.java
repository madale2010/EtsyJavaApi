...
public static void findAllFeaturedTreasuries(){EtsyService.getService("/featured_treasuries");}
...
public static void findAllFeaturedTreasuriesByOwner(String ownerId){EtsyService.getService("/featured_treasuries/owner/"+ownerId);}
}
