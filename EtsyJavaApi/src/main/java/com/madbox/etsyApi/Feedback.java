...
public static void findAllUserFeedbackAsAuthor(String userId){EtsyService.getService("/users/"+userId+"/feedback/as-author");}
//Retrieves a set of Feedback objects associated to a User.
public static void findAllUserFeedbackAsBuyer(String userId){EtsyService.getService("/users/"+userId+"/feedback/as-buyer");}
//Retrieves a set of Feedback objects associated to a User.
public static void findAllUserFeedbackAsSeller(String userId){EtsyService.getService("/users/"+userId+"/feedback/as-seller");}
//Retrieves a set of Feedback objects associated to a User.
public static void findAllUserFeedbackAsSubject(String userId){EtsyService.getService("/users/"+userId+"/feedback/as-subject");}
...
public static void findAllFeedbackFromBuyers(String userId){EtsyService.getService("/users/"+userId+"/feedback/from-buyers");}
//	Returns a set of FeedBack objects associated to a User. This is essentially the union between the findAllUserFeedbackAsBuyer and findAllUserFeedbackAsSubject methods.
public static void findAllFeedbackFromSellers(String userId){EtsyService.getService("/users/"+userId+"/feedback/from-sellers");}
